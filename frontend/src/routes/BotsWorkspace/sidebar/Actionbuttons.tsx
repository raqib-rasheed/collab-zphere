...
const ActionButtons:FC = () => {
    ...
    return <section>
        <div className="button-section">
            <button className="btn-save" onClick={onSaveClick}><i className="fa fa-check-square-o btn-i"></i> Save</button>
            <button className="btn-reset" onClick={onRestClick}><i className="fa fa-refresh btn-i"></i> Reset</button>
