          ...
          reports: {
            ...
            subMenu: {
              ...
              accountStatement: {
                ...
                path: "/payroll-setup/Account-Statement",
                icon: "ViewArray",
              },
              invoiceSummary: {
                id: "invoiceSummary",
                text: "Invoice Summary",
                path: "/payroll-setup/invoice-summary",
                icon: "ViewDay",
              },
              billSummary: {
                id: "billSummary",
                text: "Bill Summary",
                path: "/payroll-setup/Bill-Summary",
                icon: "ViewArray",
              },
              productStock: {
                id: "productStock",
                text: "Product Stock",
                path: "/payroll-setup/Product-Stock",
                icon: "ViewDay",
              },
              profitAndLoss: {
                id: "profitAndLoss",
                text: "Profit And Loss",
                path: "/payroll-setup/Profit-And-Loss",
                iLosscon: "ViewArray",
              },
              transaction: {
                id: "transaction",
                text: "Transaction",
                path: "/payroll-setup/Transaction",
                icon: "ViewDay",
              },
              incomeSummary: {
                id: "incomeSummary",
                text: "incomeSummary",
                path: "/payroll-setup/incomeSummary",
                icon: "ViewArray",
              },
              taxSummary: {
                id: "taxSummary",
                text: "taxSummary",
                path: "/payroll-setup/taxSummary",
                icon: "ViewDay",
              },
            },
          },
