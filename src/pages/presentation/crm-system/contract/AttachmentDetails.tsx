		...
		<Page container='fluid'>
			...
			<textarea
				value={`Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                     Iusto facere magnam quos,et fuga cupid
                     itate suscipit reiciendis veritatis fugit 
                     debitis architecto modisimilique assumenda ut aperiam vel, deleniti recusandae sint.`}
				rows={7}></textarea>
		</Page>
	);
};
