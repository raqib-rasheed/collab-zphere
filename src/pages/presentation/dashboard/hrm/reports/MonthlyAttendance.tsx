	...
	return (
		<PageWrapper title=''>
			...
			<div className='d-flex justify-content-between'>
				<div style={{ width: '22.5%' }} className='mx-3'>
					<Card className='p-4'>
						<h5>Attendance</h5>
						<p>Total present: 0 | leave: 0</p>
					</Card>
				</div>
				<div style={{ width: '22.5%' }} className='mx-3'>
					<Card className='p-4'>
						<h5>Overtime</h5>
						<p>Total overtime in hours : 0.00</p>
					</Card>
				</div>
				<div style={{ width: '22.5%' }} className='mx-3'>
					<Card className='p-4'>
						<h5>Attendance</h5>
						<p>Total early leave in hours : 0.00</p>
					</Card>
				</div>
				<div style={{ width: '22.5%' }} className='mx-3'>
					<Card className='p-4'>
						<h5>Attendance</h5>
						<p>Total late in hours : 0.00</p>
					</Card>
				</div>
			</div>
